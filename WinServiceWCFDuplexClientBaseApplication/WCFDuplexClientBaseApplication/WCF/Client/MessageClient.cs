...
namespace WCFDuplexClientBaseApplication
{
    ...
    public class MessageClient:IMessageClient
    {
        ...
        {
            EndpointAddress address = new EndpointAddress("net.tcp://" + wcfUri + "/MessageServer");
            messageDuplex = new MessageDuplex(this, new NetTcpBinding(SecurityMode.Message), address);
