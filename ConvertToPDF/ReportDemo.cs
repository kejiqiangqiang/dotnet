...
namespace iTextDemo
{
    public class ReportDemo
    {
        ...
        public void GeneratePDFReport()
        {
            ...
            using (document)
            {
               PdfWriter writer= PdfWriter.GetInstance(document, new FileStream(string.Format("../../Pdf/{0}-{1}.pdf", DateTime.Now.Second, DateTime.Now.Millisecond),
                    FileMode.Create));
        ...
        private void DirectDrawReport(PdfContentByte canvas)
        {
            ...
            canvas.SetColorStroke(BaseColor.GREEN);
